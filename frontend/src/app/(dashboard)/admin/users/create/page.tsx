...
export default function CreateUserPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data, error } = await usersService.createUser(formData);
      ...
      // Redirect after short delay - Use the route your app actually uses
      setTimeout(() => {
      ...
      if (err.message && err.message.includes('already exists')) {
        ...
        setErrors(prev => ({
          ...prev,
          form: `Error creating user: ${err.message || 'Unknown error'}`
        }));
      }
    } finally {
